...
# 
# sp_ascii<-list.files("f:/Current_Projects/exotic_plants/outputs",
#                     pattern="(species_current_avg.asc|average_rcp45_2035.asc|average_rcp45_2065.asc|average_rcp85_2035.asc|average_rcp85_2065.asc)"                     ,recursive=TRUE,full.names=TRUE,ignore.case = TRUE)
...
# aus_mask<-disaggregate(aus_mask,fact=2)
# 
...
locations<-na.omit(locations)
  ...
  #write output table
  write.csv(locations, "F:\\Current_Projects\\exotic_plants\\data\\website\\Australia_State_habitat_suitability_lat_long_all_apecies.csv",row.names = FALSE)
