...
work.dir<-"f:\\Current_Projects\\exotic_plants\\outputs\\all species\\"
out.dir<-"F:\\Current_Projects\\exotic_plants\\paper\\NCCARF Reports\\tables_figures\\"
regions<-as.vector(c("ACT", "NSW" ,"NT",  "QLD" ,"SA",  "TAS" ,"VIC", "WA","AUS" ))
poly_states<-states<-readShapePoly("F:\\Current_Projects\\exotic_plants\\data\\GRIDS\\data_WGS_1984\\NRM_Australia_states.shp")

########### trim rasters to states #########
{
# 
#   r<-raster(paste(work.dir,regions[1],"_RCP85_2035_sum_all_species.asc",sep=""))
# # 
#   a<-rasterize(poly_states,r,field="STATE")
# # ID              STATE
# # 1  1                ACT
# # 2  2 External Territory
# # 3  3                NSW
# # 4  4                 NT
# # 5  5                QLD
# # 6  6                 SA
