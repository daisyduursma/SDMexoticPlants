...
for (i in 1:length(species)){
  ...
  noneur<-subset(occurence,Europe==0)
  Eur_obs_box<-nrow(eur)
  non_Eur_obs_box<-nrow(noneur)
  locs<-cbind(eur$lon,eur$lat)
...
write.csv(Eur_USA_observation_summary,paste(work.dir,"Eur_USA_observation_summary_21_10_13.csv",sep=""))
