...
out.dir<-"C:\\Daisy\\Current_Projects\\exotic_plants\\outputs\\all species\\"
grid.dir<-"C:\\Daisy\\Current_Projects\\exotic_plants\\data\\GRIDS\\data_WGS_1984\\"

r1<-raster("c:/daisy/Current_Projects/exotic_plants/outputs/Acanthocereus tetragonus_final2/Australia_species_current_avg_thresholded_10.asc")
...
#   
  ...
  scen<-c("Australia_species_current_avg_thresholded_10.asc","Australia_average_rcp85_2035_thresholded_10.asc","Australia_average_rcp85_2065_thresholded_10.asc")
   scen2<-c("current","rcp85_2035","rcp85_2065")
  ...
  #write output table
  write.csv(locations,paste(out.dir,scen2[i],"_Presence_absence_lat_long_all_apecies_19_08_3013.csv"))
...
#######for IBRA7_regions restricted ##################3
{
  
  
  r1<-raster("f:/daisy/Current_Projects/exotic_plants/outputs/Acanthocereus tetragonus_final2/thresholded_current_10.asc")
  r1<-disaggregate(r1,fact=3)
  b<-area(r1)
  ...
  write.csv(final_all_dat,"F:\\daisy\\Current_Projects\\exotic_plants\\Website\\area_suitability\\IBRA7_percent_suitable_habitat.csv",row.names=FALSE)
