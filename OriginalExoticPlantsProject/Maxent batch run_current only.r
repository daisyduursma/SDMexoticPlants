...
out.dir<-"C:\\Daisy\\Current_Projects\\exotic_plants\\outputs\\logistic\\3_09_12\\"
dir.create(out.dir)
...
#read in SWD files
	...
	all_background<-read.table(paste(work.dir,"RK_background_SWD_8_8_12.csv", sep=""),header=TRUE, sep=",")
...
for (i in 1:length(species)){
  ...
  #get 10,000 background points
	...
	#path to write out files
		new.out.dir<-(paste(out.dir,species[i],"_set1_bgRK_r3.0_nhnt",sep=""))
		
	#maxent runs
		maxent(x=ev,p=pres,path=paste(new.out.dir),args=c("betamultiplier=3","nohinge","nothreshold","replicates=5","nooutputgrids","projectionlayers=C:\\Daisy\\Raw Data\\Current Climate\\"))
	...
	#path to write out files
		new.out.dir<-(paste(out.dir,species[i],"_set2_bgRK_r1.0_nhnt",sep=""))
	...
	#path to write out files
		new.out.dir<-(paste(out.dir,species[i],"_set2_bgRK_r3.0_nhnt",sep=""))
